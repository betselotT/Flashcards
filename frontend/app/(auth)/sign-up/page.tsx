    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="bg-white/80 backdrop-blur-xl p-8 sm:p-10 rounded-3xl shadow-2xl w-full max-w-md border border-gray-200">
          ...
          {error && (
            <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-2xl text-red-600 text-sm animate-shake">
              {error}
            </div>
          )}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs text-gray-500 mt-2">
                Password must be 8+ characters with letter, number, and special
                character
              </div>
            </div>
